                ...
                <div className="space-y-4">
                    {history.length === 0 ? (
                        ...
                        history.map((item, idx) => (
                            <div key={idx} className="bg-bg-card border border-border-color rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow transition-all group" style={{ animationDelay: `${idx * 20}ms` }}>
